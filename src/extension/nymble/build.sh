...
ROOT_DIRS="components"         # ...and these directories       (space separated list)
BEFORE_BUILD=      cp ../INymble.xpt ../Nymble.dylib components # run this before building       (bash command)
...
for DIR in $ROOT_DIRS components; do
  mkdir $TMP_DIR/$DIR
