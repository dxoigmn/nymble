...
// required int32 time_period = 1;
inline bool LinkingToken::has_time_period() const {
  return _has_bit(0);
}
inline void LinkingToken::clear_time_period() {
  time_period_ = 0;
  _clear_bit(0);
}
inline ::google::protobuf::int32 LinkingToken::time_period() const {
  return time_period_;
}
inline void LinkingToken::set_time_period(::google::protobuf::int32 value) {
  _set_bit(0);
  time_period_ = value;
}
